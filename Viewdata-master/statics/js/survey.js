$(function () {
    ...
    function ceshis() {
            ...
            $.ajax({
            url:"http://127.0.0.1:5000/survey/shuiipin",
    ...
    function ceshis1() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/survey/chart2",
            success:function(data){
    ...
    function ceshis2() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/survey/chart3",
            success:function(data){
               var option12 = {
            /*backgroundColor: '#000',*/
            "animation": true,
    ...
    function ceshis3() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/survey/chart4",
            success:function(data){
                 var option = {
    ...
    function ceshis4() {
        var myChart = echarts.init(document.getElementById('chart5'));
                $.ajax({
            url:"http://127.0.0.1:5000/survey/chart5",
            success:function(data){
                var labelimg = "";
                option = {
...
// }
    ...
    function ceshis6() {
        ...
        $.ajax({
            url:"http://127.0.0.1:5000/survey/diqu",
